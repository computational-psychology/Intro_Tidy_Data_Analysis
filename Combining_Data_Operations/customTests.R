...
#' Test that the user's result equals an expected value.
#' 
#' Unlike omnitest(correctVal=...), this works with dataframes and other
#' non-scalar values by using all.equal() for comparison.
